...
description: 'Build a personalized X/Twitter personal brand playbook for Solana founders. Matches the founder to one of 8 researched archetypes (Protocol Philosopher, Ecosystem Operator, Engineer Minimalist, Contrarian Trader, Research Maximalist, Consumer Storyteller, Degen Builder Poet, Memetic Provocateur) and produces a unique POV, content pillars with core CTAs, community identity layer, voice style guide, weekly posting rhythm, regional seeding targets, and 10 example posts in their voice. Use when a Solana founder asks for help with founder twitter, personal brand, POV, posting cadence, or content strategy on X. Grounds outputs in real Solana-founder patterns from anchor accounts, not generic advice. Optionally fetches live posts from an X handle for tighter voice matching.'
---
